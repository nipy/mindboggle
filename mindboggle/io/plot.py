...
# import numpy as np
# import surfer
# from mindboggle.io.vtk import read_scalars as rs
...
def plot_mask_surface(vtk_file, mask_file='', nonmask_value=-1,
    ...
    --------
    >>> import os
    >>> from mindboggle.io.plot import plot_mask_surface
    >>> path = os.environ['MINDBOGGLE_DATA']
...
def histogram_of_vtk_scalars(vtk_file, nbins=100):
    ...
    --------
    >>> import os
    >>> from mindboggle.io.plot import histogram_of_vtk_scalars
    >>> path = os.environ['MINDBOGGLE_DATA']
...
def histograms_of_lists(columns, column_name='', ignore_columns=[],
    ...
    Examples
    --------
    >>> from mindboggle.io.plot import histograms_of_lists
...
def boxplots_of_lists(columns, xlabel='', ylabel='', ylimit=None, title=''):
    ...
    Examples
    --------
    >>> from mindboggle.io.plot import boxplots_of_lists
    >>> columns = [[1,1,2,2,2,2,2,2,3,3,3,4,4,8],[2,2,3,3,3,3,5,6,7],
...
def scatterplot_lists(y_columns, x_column, ignore_columns=[], plot_line=True,
    ...
    Examples
    --------
    >>> from mindboggle.io.plot import scatterplot_lists
...
def scatterplot_list_pairs(columns, ignore_first_column=False, plot_line=True,
    ...
    Examples
    --------
    >>> from mindboggle.io.plot import scatterplot_list_pairs
