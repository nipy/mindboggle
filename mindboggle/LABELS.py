...
class DKTprotocol:
    ...
    right_cerebrum_noncortex_numbers_names = [
        ...
        [4035, "wm-rh-insula"]]
    left_ventricle_numbers_names = [
        [4, "left lateral ventricle"],
        [5, "left inferior lateral ventricle"]]
    right_ventricle_numbers_names = [
        [43, "right lateral ventricle"],
        [44, "right inferior lateral ventricle"]]
    medial_ventricle_numbers_names = [
        [14, "3rd ventricle"],
        [15, "4th ventricle"],
        [72, "5th ventricle"]]
    ...
    left_ventricle_numbers = [x[0] for x in left_ventricle_numbers_names]
    right_ventricle_numbers = [x[0] for x in right_ventricle_numbers_names]
    medial_ventricle_numbers = [x[0] for x in medial_ventricle_numbers_names]
    ...
    left_ventricle_names = [x[1] for x in left_ventricle_numbers_names]
    right_ventricle_names = [x[1] for x in right_ventricle_numbers_names]
    medial_ventricle_names = [x[1] for x in medial_ventricle_numbers_names]
    ...
    left_cerebellum_cortex_numbers = [x[0] for x in
                                      left_cerebellum_cortex_numbers_names]
    right_cerebellum_cortex_numbers = [x[0] for x in
                                       right_cerebellum_cortex_numbers_names]
    left_cerebellum_cortex_names = [x[1] for x in
                                    left_cerebellum_cortex_numbers_names]
    right_cerebellum_cortex_names = [x[1] for x in
                                     right_cerebellum_cortex_numbers_names]
    left_cerebellum_noncortex_numbers = [x[0] for x in
                                         left_cerebellum_noncortex_numbers_names]
    right_cerebellum_noncortex_numbers = [x[0] for x in
                                          right_cerebellum_noncortex_numbers_names]
    medial_cerebellum_noncortex_numbers = [x[0] for x in
                                           medial_cerebellum_noncortex_numbers_names]
    left_cerebellum_noncortex_names = [x[1] for x in
                                       left_cerebellum_noncortex_numbers_names]
    right_cerebellum_noncortex_names = [x[1] for x in
                                        right_cerebellum_noncortex_numbers_names]
    medial_cerebellum_noncortex_names = [x[1] for x in
                                         medial_cerebellum_noncortex_numbers_names]
    ...
    number_name_rgb = [
        ...
        [500, "right_CA2_3", [17, 85, 136]],
        [501, "right_alveus", [119, 187, 102]],
        [502, "right_CA1", [204, 68, 34]],
        [503, "right_fimbria", [204, 0, 255]],
        [504, "right_presubiculum", [221, 187, 17]],
        [505, "right_hippocampal_fissure", [153, 221, 238]],
        [506, "right_CA4_DG", [51, 17, 17]],
        [507, "right_subiculum", [0, 119, 85]],
        [508, "right_fornix", [20, 100, 200]],
        [550, "left_CA2_3", [17, 85, 137]],
        [551, "left_alveus", [119, 187, 103]],
        [552, "left_CA1", [204, 68, 35]],
        [553, "left_fimbria", [204, 0, 254]],
        [554, "left_presubiculum", [221, 187, 16]],
        [555, "left_hippocampal_fissure", [153, 221, 239]],
        [556, "left_CA4_DG", [51, 17, 18]],
        [557, "left_subiculum", [0, 119, 86]],
        [558, "left_fornix", [20, 100, 201]],
        [630, "cerebellar vermal lobules I-V", [250, 255, 130]],
        [631, "cerebellar vermal lobules VI-VII", [250, 255, 140]],
        [632, "cerebellar vermal lobules VIII-X", [250, 255, 150]],
        ...
        [3000, "wm-lh-unknown", [230, 250, 230]],
        [3001, "wm-lh-bankssts", [230, 155, 215]],
        [3002, "wm-lh-caudalanteriorcingulate", [130, 155, 95]],
        [3003, "wm-lh-caudalmiddlefrontal", [155, 230, 255]],
        [3004, "wm-lh-corpuscallosum", [135, 185, 205]],
        [3005, "wm-lh-cuneus", [35, 235, 155]],
        [3006, "wm-lh-entorhinal", [35, 235, 245]],
        [3007, "wm-lh-fusiform", [75, 35, 115]],
        [3008, "wm-lh-inferiorparietal", [35, 195, 35]],
        [3009, "wm-lh-inferiortemporal", [75, 215, 135]],
        [3010, "wm-lh-isthmuscingulate", [115, 235, 115]],
        [3011, "wm-lh-lateraloccipital", [235, 225, 115]],
        [3012, "wm-lh-lateralorbitofrontal", [220, 180, 205]],
        [3013, "wm-lh-lingual", [30, 115, 115]],
        [3014, "wm-lh-medialorbitofrontal", [55, 220, 180]],
        [3015, "wm-lh-middletemporal", [95, 155, 205]],
        [3016, "wm-lh-parahippocampal", [235, 35, 195]],
        [3017, "wm-lh-paracentral", [195, 35, 195]],
        [3018, "wm-lh-parsopercularis", [35, 75, 115]],
        [3019, "wm-lh-parsorbitalis", [235, 155, 205]],
        [3020, "wm-lh-parstriangularis", [35, 195, 235]],
        [3021, "wm-lh-pericalcarine", [135, 155, 195]],
        [3022, "wm-lh-postcentral", [35, 235, 235]],
        [3023, "wm-lh-posteriorcingulate", [35, 75, 35]],
        [3024, "wm-lh-precentral", [195, 235, 35]],
        [3025, "wm-lh-precuneus", [95, 115, 75]],
        [3026, "wm-lh-rostralanteriorcingulate", [175, 235, 115]],
        [3027, "wm-lh-rostralmiddlefrontal", [180, 205, 130]],
        [3028, "wm-lh-superiorfrontal", [235, 35, 95]],
        [3029, "wm-lh-superiorparietal", [235, 75, 115]],
        [3030, "wm-lh-superiortemporal", [115, 35, 35]],
        [3031, "wm-lh-supramarginal", [175, 95, 235]],
        [3032, "wm-lh-frontalpole", [155, 255, 155]],
        [3033, "wm-lh-temporalpole", [185, 185, 185]],
        [3034, "wm-lh-transversetemporal", [105, 105, 55]],
        [3035, "wm-lh-insula", [254, 191, 31]],
        [4000, "wm-rh-unknown", [230, 250, 230]],
        [4001, "wm-rh-bankssts", [230, 155, 215]],
        [4002, "wm-rh-caudalanteriorcingulate", [130, 155, 95]],
        [4003, "wm-rh-caudalmiddlefrontal", [155, 230, 255]],
        [4004, "wm-rh-corpuscallosum", [135, 185, 205]],
        [4005, "wm-rh-cuneus", [35, 235, 155]],
        [4006, "wm-rh-entorhinal", [35, 235, 245]],
        [4007, "wm-rh-fusiform", [75, 35, 115]],
        [4008, "wm-rh-inferiorparietal", [35, 195, 35]],
        [4009, "wm-rh-inferiortemporal", [75, 215, 135]],
        [4010, "wm-rh-isthmuscingulate", [115, 235, 115]],
        [4011, "wm-rh-lateraloccipital", [235, 225, 115]],
        [4012, "wm-rh-lateralorbitofrontal", [220, 180, 205]],
        [4013, "wm-rh-lingual", [30, 115, 115]],
        [4014, "wm-rh-medialorbitofrontal", [55, 220, 180]],
        [4015, "wm-rh-middletemporal", [95, 155, 205]],
        [4016, "wm-rh-parahippocampal", [235, 35, 195]],
        [4017, "wm-rh-paracentral", [195, 35, 195]],
        [4018, "wm-rh-parsopercularis", [35, 75, 115]],
        [4019, "wm-rh-parsorbitalis", [235, 155, 205]],
        [4020, "wm-rh-parstriangularis", [35, 195, 235]],
        [4021, "wm-rh-pericalcarine", [135, 155, 195]],
        [4022, "wm-rh-postcentral", [35, 235, 235]],
        [4023, "wm-rh-posteriorcingulate", [35, 75, 35]],
        [4024, "wm-rh-precentral", [195, 235, 35]],
        [4025, "wm-rh-precuneus", [95, 115, 75]],
        [4026, "wm-rh-rostralanteriorcingulate", [175, 235, 115]],
        [4027, "wm-rh-rostralmiddlefrontal", [180, 205, 130]],
        [4028, "wm-rh-superiorfrontal", [235, 35, 95]],
        [4029, "wm-rh-superiorparietal", [235, 75, 115]],
        [4030, "wm-rh-superiortemporal", [115, 35, 35]],
        [4031, "wm-rh-supramarginal", [175, 95, 235]],
        [4032, "wm-rh-frontalpole", [155, 255, 155]],
        [4033, "wm-rh-temporalpole", [185, 185, 185]],
        [4034, "wm-rh-transversetemporal", [105, 105, 55]],
        [4035, "wm-rh-insula", [254, 191, 31]]]
...
FreeSurferColorLUT = [
    ...
    [557, "left_subiculum", [0, 119, 86]],
    [558, "left_fornix", [20, 100, 201]],
    [601, "Cbm_Left_I_IV", [70, 130, 180]],
    [602, "Cbm_Right_I_IV", [245, 245, 245]],
    [603, "Cbm_Left_V", [205, 62, 78]],
    [604, "Cbm_Right_V", [120, 18, 134]],
    [605, "Cbm_Left_VI", [196, 58, 250]],
    [606, "Cbm_Vermis_VI", [0, 148, 0]],
    [607, "Cbm_Right_VI", [220, 248, 164]],
    [608, "Cbm_Left_CrusI", [230, 148, 34]],
    [609, "Cbm_Vermis_CrusI", [0, 118, 14]],
    [610, "Cbm_Right_CrusI", [0, 118, 14]],
    [611, "Cbm_Left_CrusII", [122, 186, 220]],
    [612, "Cbm_Vermis_CrusII", [236, 13, 176]],
    [613, "Cbm_Right_CrusII 12", [48, 255, 0]],
    [614, "Cbm_Left_VIIb", [204, 182, 142]],
    [615, "Cbm_Vermis_VIIb", [42, 204, 164]],
    [616, "Cbm_Right_VIIb", [119, 159, 176]],
    [617, "Cbm_Left_VIIIa", [220, 216, 20]],
    [618, "Cbm_Vermis_VIIIa", [103, 255, 255]],
    [619, "Cbm_Right_VIIIa", [80, 196, 98]],
    [620, "Cbm_Left_VIIIb", [60, 58, 210]],
    [621, "Cbm_Vermis_VIIIb", [60, 58, 210]],
    [622, "Cbm_Right_VIIIb", [60, 58, 210]],
    [623, "Cbm_Left_IX", [60, 58, 210]],
    [624, "Cbm_Vermis_IX", [60, 60, 60]],
    [625, "Cbm_Right_IX", [255, 165, 0]],
    [626, "Cbm_Left_X", [255, 165, 0]],
    [627, "Cbm_Vermis_X", [0, 255, 127]],
    [628, "Cbm_Right_X", [165, 42, 42]],
    [640, "Cbm_Right_I_V_med", [204, 0, 0]],
    [641, "Cbm_Right_I_V_mid", [255, 0, 0]],
    [642, "Cbm_Right_VI_med", [0, 0, 255]],
    [643, "Cbm_Right_VI_mid", [30, 144, 255]],
    [644, "Cbm_Right_VI_lat", [100, 212, 237]],
    [645, "Cbm_Right_CrusI_med", [218, 165, 32]],
    [646, "Cbm_Right_CrusI_mid", [255, 215, 0]],
    [647, "Cbm_Right_CrusI_lat", [255, 255, 166]],
    [648, "Cbm_Right_CrusII_med", [153, 0, 204]],
    [649, "Cbm_Right_CrusII_mid", [153, 141, 209]],
    [650, "Cbm_Right_CrusII_lat", [204, 204, 255]],
    [651, "Cbm_Right_7med", [31, 212, 194]],
    [652, "Cbm_Right_7mid", [3, 255, 237]],
    [653, "Cbm_Right_7lat", [204, 255, 255]],
    [654, "Cbm_Right_8med", [86, 74, 147]],
    [655, "Cbm_Right_8mid", [114, 114, 190]],
    [656, "Cbm_Right_8lat", [184, 178, 255]],
    [657, "Cbm_Right_PUNs", [126, 138, 37]],
    [658, "Cbm_Right_TONs", [189, 197, 117]],
    [659, "Cbm_Right_FLOs", [240, 230, 140]],
    [660, "Cbm_Left_I_V_med", [204, 0, 0]],
    [661, "Cbm_Left_I_V_mid", [255, 0, 0]],
    [662, "Cbm_Left_VI_med", [0, 0, 255]],
    [663, "Cbm_Left_VI_mid", [30, 144, 255]],
    [664, "Cbm_Left_VI_lat", [100, 212, 237]],
    [665, "Cbm_Left_CrusI_med", [218, 165, 32]],
    [666, "Cbm_Left_CrusI_mid", [255, 215, 0]],
    [667, "Cbm_Left_CrusI_lat", [255, 255, 166]],
    [668, "Cbm_Left_CrusII_med", [153, 0, 204]],
    [669, "Cbm_Left_CrusII_mid", [153, 141, 209]],
    [670, "Cbm_Left_CrusII_lat", [204, 204, 255]],
    [671, "Cbm_Left_7med", [31, 212, 194]],
    [672, "Cbm_Left_7mid", [3, 255, 237]],
    [673, "Cbm_Left_7lat", [204, 255, 255]],
    [674, "Cbm_Left_8med", [86, 74, 147]],
    [675, "Cbm_Left_8mid", [114, 114, 190]],
    [676, "Cbm_Left_8lat", [184, 178, 255]],
    [677, "Cbm_Left_PUNs", [126, 138, 37]],
    [678, "Cbm_Left_TONs", [189, 197, 117]],
    [679, "Cbm_Left_FLOs", [240, 230, 140]],
    [1000, "ctx-lh-unknown", [25, 5, 25]],
    [1001, "ctx-lh-bankssts", [25, 100, 40]],
    [1002, "ctx-lh-caudalanteriorcingulate", [125, 100, 160]],
    [1003, "ctx-lh-caudalmiddlefrontal", [100, 25, 0]],
