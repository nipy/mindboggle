...
if process_phantoms:
    max_angle = 15
    if process_DTI:
        temp_path = os.path.join(temp_path, 'Scratch_DTI_phantoms')
    else:
        temp_path = os.path.join(temp_path, 'Scratch_phantoms')
else:
    max_angle = 90
    if process_DTI:
        temp_path = os.path.join(temp_path, 'Scratch_DTI')
    else:
        #run_bet = True
...
if process_phantoms:
    ...
    if process_DTI:
        ...
        image_list = os.path.join(data_path, 'FA_file_list.txt')
        reg_images_path = os.path.join(data_path, 'dmri_1stvol_20130123')
        reg_image_list = os.path.join(data_path, '1stvol_file_list.txt')
