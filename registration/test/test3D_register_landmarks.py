...
outpath = output_dir+"test3D/"+regularizer+"_"+intensity_measure+"_"+landmark_measure+"/"
results = output_dir+"test3D/"+regularizer+"_"+intensity_measure+"_"+landmark_measure+".csv"
ext = ".nii.gz"
