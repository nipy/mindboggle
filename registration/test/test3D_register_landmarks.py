"""
Test of 2-D landmark-based registration of 3-D image volumes.
...
source = "data/S20_to_S05.nii.gz"
target = "data/S05.nii.gz"
#labels = [23,27]
...
source_labels = "data/S20_to_S05_labels.nii.gz"
target_labels = "data/S05_labels.nii.gz"
source_landmarks = "data/S20_to_S05_leftPreCS_in_axial196.nii.gz"
target_landmarks = "data/S05_leftPreCS_in_axial196.nii.gz"
regularizer = "Gauss"
intensity_measure = "MSQ"
landmark_measure = "PSE"
outpath = "output/test3D/"+regularizer+"_"+intensity_measure+"_"+landmark_measure+"/"
results = "results/test2D_"+regularizer+"_"+intensity_measure+"_"+landmark_measure+".csv"
ext = ".nii.gz"
...
#
dim = 3
gradient_step_sizes = [0.1, 0.3, 0.5]
...
if regularizer == "DMFFD":
    regularizer_settings = ['6x12x12','12x12x12']  # DMFFD iterations
    bspline_order = 3
elif regularizer == "Gauss":
    regularizer_settings = [2, 5, 10]  # similarity gradient sigma
    deformation_field_sigma = 0

#
# Intensity parameters
#
intensity_weights = [0.0, 0.1, 0.2]
