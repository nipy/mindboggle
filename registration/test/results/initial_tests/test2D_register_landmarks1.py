...
outpath = "output/"
results = 'results/test2D_average_overlaps1.csv'
ext = ".nii.gz"
...
#
dim = 2
gradient_step_sizes = [0.1, 0.2, 0.5]
iterations = "100x100"
