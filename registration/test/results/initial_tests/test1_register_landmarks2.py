...
outpath = "output/"
results = 'results/test1_registration_average_overlaps2.csv'
ext = ".nii.gz"
...
#
intensity_weights = [0.5]
intensity_measure = "CC"
if intensity_measure == "CC":
    intensity_settings = [3]  # radius
...
if landmark_measure == "PSE":
    ...
    sigmas = [20] # big numbers are nearly uniform distributions
    neighbors = [5]
