...
Output
------------------------------------------------------------------------------
Example output data generated by Mindboggle can be accessed from the arno/mindboggled (and arno/mindboggle_working) folder in `Mindboggle/data <https://osf.io/36gdy/>`_ on osf.io.
