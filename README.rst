...
directory (450 MB), which contains abridged FreeSurfer and ANTs output
for one person.
...
**Example 1:**
The following bare-bones command runs Mindboggle on data processed
by FreeSurfer but not ANTs (for "example" in the $HOME directory)::
