function [output]=applyNewman(adj_matrix,options)
% The method apply the Newman algorithm to an adjacency matrix in order to
...
%           others.
%
% Note: the newman method is included in the brain connectivity toolbox.
...
[cluster_indices Q Nc NNc] = modularity_und(W);
