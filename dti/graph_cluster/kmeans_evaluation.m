% STUDY OF K-MEANS
% Code to evaluate the performances of the k-means clustering method.
% Questions:
% - method robustness
...
options.frequency_probability_threshold = 0.7;
options.saveImages = true;
options.images_basename = ['kmeans_',num2str(options.n_cluster),'_',options.kmeans.distance];
...
for g = 1:nG
    ...
    cluster_results = applyKmeans(graph_adj_matrix,options);
