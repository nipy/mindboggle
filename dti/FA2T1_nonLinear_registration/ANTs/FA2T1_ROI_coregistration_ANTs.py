...
ANTs and the direct transformation refers to the one from DTI to T1 space.
...
ants_warp_FA_2_T1 = main_folder + "ants_T1/FA_2_T1_Warp.nii.gz"
ants_warp_T1_2_FA = main_folder + "ants_T1/FA_2_T1_InverseWarp.nii.gz"
ants_affine       = main_folder + "ants_T1/FA_2_T1_Affine.txt"
T1_data           = main_folder + "T1_cropped.nii.gz"
ROI_on_T1         = main_folder + "roi_T1_cropped.nii.gz"

# Output files
temporary_folder   = main_folder + "ants_T1/trilinear_coregistration_ants" + os.sep
