#!/usr/bin/python
"""
Measure the Hausdorff distance between landmarks.
...
#atlas_borders_dir  = '/hd2/Brains/CUMC12/Atlas_Borders/'
#xfm_borders_dir = os.path.join( out_path, 'Transformed_Atlas_borders/')
#label_file         = 'CUMC12_labels_regions.txt'

avg_results_file = results_dir+'avg_hausdorff_distance_'+landmark_type+'.txt'
        ...
        if file2 != file:
            ...
            if os.path.exists(source_file) and \
               os.path.exists(target_file):
                ...
                results_file = results_dir+'hausdorff_distance_'+landmark_type+'.txt'
                ...
                args4 = " ".join(['c3d', append+file+ext, target_file, \
                                 '-multiply -o', append+'from_'+target])
                args5 = " ".join(['c3d', append+'from_'+target, \
                                         source_file, '-lstat > ', temp_file1])
                args6 = " ".join(['c3d', append+'from_'+source, \
                                         target_file, '-lstat > ', temp_file2])
                """
